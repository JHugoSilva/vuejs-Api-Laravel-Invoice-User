...
const updateProduct = async () => {
    ...
    formData.append('price', form.value.unit_price)
    formData.append('_method', 'PUT')

    axios.post(`/api/product/${form.value.id}`, formData).then((response) => {
            ...
            <div class="products__create__cardWrapper mt-2">
                ...
                <div class="products__create__sidebar">
                    ...
                    <div class="card py-2 px-2 bg-white">
                        ...
                        <div class="my-3">
                            <p>Price</p>
                            <input type="text" class="input" v-model="form.unit_price">
                        </div>
                    </div>
