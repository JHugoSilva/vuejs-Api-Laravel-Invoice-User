<script setup>
    ...
    const addCart = (item) => {
        ...
        const itemCart = listCart.value.find((itemCart) => itemCart.id === itemcart.id)
            ...
            <div class="card__content--header">
                <div>
                    ...
                    <select name="" id="" class="input" v-model="customerId">
                        ...
                        <option v-for="customer in allCustomers" :value="customer.id" :Key="customer.id">{{ customer.firstname }}</option>
                    </select>
                </div>
                <div>
                    <p class="my-1">Date</p>
    ...
    <div class="modal main__modal " :class="{ show: showModal }">
        <div class="modal__content">
            ...
            <div class="model__footer">
                <button class="btn btn-light mr-2 btn__close--modal" @click="openModel()">
                    Cancel
                </button>
